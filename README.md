...
- поиск по файлам, папкам, закладкам и заметкам;
...
Подробнее об устройстве проекта см. в [ARCHITECTURE.md](ARCHITECTURE.md), инструкция по рабочему развёртыванию — в [DEPLOYMENT_ORANGE_PI.md](DEPLOYMENT_ORANGE_PI.md), история изменений находится в [CHANGELOG.md](CHANGELOG.md).
